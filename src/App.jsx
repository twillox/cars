          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <nav className="flex items-center space-x-1">
              <button 
                ...
                className={`px-3 py-1.5 rounded-lg text-xs md:text-sm font-bold transition-all ${currentPage === 'home' ? 'text-blue-600 bg-blue-50' : 'text-slate-600 hover:text-[#0F172A]'}`}
              >
                Home
              </button>
              <button 
                onClick={() => setCurrentPage('inventory')}
                className={`px-3 py-1.5 rounded-lg text-xs md:text-sm font-bold transition-all ${currentPage === 'inventory' ? 'text-blue-600 bg-blue-50' : 'text-slate-600 hover:text-[#0F172A]'}`}
              >
                Browse Cars
              </button>
              <button 
                onClick={() => setCurrentPage('sell')}
                className={`px-3 py-1.5 rounded-lg text-xs md:text-sm font-bold transition-all ${currentPage === 'sell' ? 'text-blue-600 bg-blue-50' : 'text-slate-600 hover:text-[#0F172A]'}`}
              >
                Sell Instantly
              </button>
            </nav>
